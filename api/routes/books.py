...
@router.get("/", response_model=OrderedDict[int, Book], status_code=status.HTTP_200_OK, summary="Get all books",
    ...
    responses={
        201: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "id": 4, "title": "New Book", "author": "Author Name", "publication_year": 2024, "genre": "FICTION"
                    }
                }
            }
        },
        ...
        422: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "detail": [
                            {"loc": ["body", "publication_year"], "msg": "value is not a valid integer", "type": "type_error.integer"}
                        ]
                    }
                }
            }
...
@router.get("/{book_id}", response_model=Book, status_code=status.HTTP_200_OK, summary="Get a specific book",
        ...
        422: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "detail": [
                            {"loc": ["path", "book_id"], "msg": "value is not a valid integer", "type": "type_error.integer"}
                        ]
                    }
                }
            }
...
@router.put("/{book_id}", response_model=Book, status_code=status.HTTP_200_OK, summary="Update a book",
    ...
    responses={
        200: {
            ...
            "content": {
                "application/json": {
                    "example": {
                        "id": 1, "title": "Updated Title", "author": "Updated Author", "publication_year": 2024, "genre": "FICTION"
                    }
                }
            }
        },
